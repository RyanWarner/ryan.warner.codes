...
description: Reduce cognitive load using visual cues by theming your apps.
date: 1549152000
icon: default
type: article
ogImage: ''
...
I recently started a new project, [Let's Go Design](https://lets-go.design). Naturally, this means a new top-level folder in my `_projects/` directory. I like to customize the icons of these folders for visual cues when browsing these folders.

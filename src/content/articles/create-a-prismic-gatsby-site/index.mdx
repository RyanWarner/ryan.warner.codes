...
There's a lot more functionality we could add or explore. Prismic slices, images, and previews are all important features that I will explore in future posts.

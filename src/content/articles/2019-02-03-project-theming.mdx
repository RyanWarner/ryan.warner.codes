...
Do you often work on more than one codebase or project in a day? Context switching can slow down productivity, but it's often unavoidable. Using visual cues bubilt right in to the tools I use everyday has helped be switch between projects more efficiently, sometimes without even losing flow state.

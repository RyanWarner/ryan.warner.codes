...
Use **[@loadable/components](https://github.com/smooth-code/loadable-components)**. This library is recommended by the React team, is actively maintained, and supports all the features we need (namely SSR).

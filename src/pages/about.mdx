...
I built this website in late December, 2019. The code is open source on [GitHub](https://github.com/RyanWarner/ryan.warner.codes), and the design is publically available in [Figma](https://www.figma.com/file/yLWWKJQsPVB06wlXfddg8H/ryan.warner.codes?node-id=22%3A1).

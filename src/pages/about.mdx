...
- I play guitar and bass. I’m learning to record my own songs.

- I watch a lot of SciFi series. Farscape, Deep Space Nine, and Star Wars: The Clone Wars are some of my favorites.

## This website

I built this website in late December, 2019. The code is open source on [GitHub](https://github.com/RyanWarner/portfolio), and the design is publically available in [Figma](https://www.figma.com/file/yLWWKJQsPVB06wlXfddg8H/ryan.warner.codes?node-id=22%3A1).

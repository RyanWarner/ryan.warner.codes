...
I prioritize communication while building. I use screen casts, video calls, and written words to lead teams built on trust and transparency.
...
You can checkout the tools I use for working on my [uses page](/uses).

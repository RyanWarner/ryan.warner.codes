...
exports.onCreatePage = ({ page, actions }) => {
  ...
  if (page.path.match(/stream-starting/) || page.path.match(/stream-commands/) || page.path.match(/stream-ending/) || page.path.match(/stream-brb/) || page.path.match(/stream-chatting/)) {
